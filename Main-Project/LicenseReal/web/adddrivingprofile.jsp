                                    ...
                                    <form action="addtodrivingpro?id=${load_profile.getId()}" method="POST" enctype="multipart/form-data">
                                        <div class="contact-info">
                                            ...
                                            <div class="content d-flex">
                                                ...
                                                <div class="input-info">
                                                    <input type="file" name="img_user" id="file-input-user" onchange="previewImage(event)" accept="image/*" required >
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="basic-info">
                                            ...
                                            <div class="content d-flex">
                                                ...
                                                <div class="input-info">
                                                    <input type="file" name="img_cccd" id="file-input-cccd"  onchange="previewImage(event)" accept="image/*" required >
                                                </div>
                                            </div>
                                            <div class='left d-flex flex-column gap-3'>
                                                <div class='avatar-user'>
                                        ...
                                        <div class="mt-5 d-flex gap-3" style="margin-left: 150px;">
                                            ...
                                            <button class="btn btn-primary" type="submit">Nộp Hồ Sơ</button>
